...
evaluate(n::Int, x::Real, a::AbstractVector{<:Real}, b::AbstractVector{<:Real}) = evaluate(n, [x],
                                                                                           a, b)
...
evaluate(ns, x::Real, a::AbstractVector{<:Real}, b::AbstractVector{<:Real}) = evaluate(ns, [x], a,
                                                                                       b)
...
evaluate(n::AbstractVector{<:Int}, x::AbstractVector{<:Real}, a::AbstractVector{<:AbstractVector{<:Real}}, b::AbstractVector{<:AbstractVector{<:Real}}) = evaluate(n,
                                                                                                                                                                   reshape(x,
                                                                                                                                                                           1,
                                                                                                                                                                           length(x)),
                                                                                                                                                                   a,
                                                                                                                                                                   b)
evaluate(n::AbstractVector{<:Int}, x::AbstractMatrix{<:Real}, op::MultiOrthoPoly) = evaluate(n, x,
                                                                                             coeffs(op)...)
evaluate(n::AbstractVector{<:Int}, x::AbstractVector{<:Real}, op::MultiOrthoPoly) = evaluate(n,
                                                                                             reshape(x,
                                                                                                     1,
                                                                                                     length(x)),
                                                                                             op)
...
evaluate(ind::AbstractMatrix{<:Int}, x::AbstractMatrix{<:Real}, op::MultiOrthoPoly) = evaluate(ind,
                                                                                               x,
                                                                                               coeffs(op)...)
evaluate(x::AbstractMatrix{<:Real}, mop::MultiOrthoPoly) = evaluate(mop.ind, x, mop)

evaluate(ind::AbstractMatrix{<:Int}, x::AbstractVector{<:Real}, a::AbstractVector{<:AbstractVector{<:Real}}, b::AbstractVector{<:AbstractVector{<:Real}}) = evaluate(ind,
                                                                                                                                                                     reshape(x,
                                                                                                                                                                             1,
                                                                                                                                                                             length(x)),
                                                                                                                                                                     a,
                                                                                                                                                                     b)
evaluate(ind::AbstractMatrix{<:Int}, x::AbstractVector{<:Real}, op::MultiOrthoPoly) = evaluate(ind,
                                                                                               reshape(x,
                                                                                                       1,
                                                                                                       length(x)),
                                                                                               coeffs(op)...)
evaluate(x::AbstractVector{<:Real}, mop::MultiOrthoPoly) = evaluate(mop.ind,
                                                                    reshape(x, 1, length(x)), mop)
