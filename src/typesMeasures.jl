...
struct Measure <: AbstractMeasure
    ...
    symmetric::Bool
    pars::Dict
    function Measure(name::String, w::Function, dom::Type_for_function, symm::Bool,
            d::Dict = Dict())
...
struct JacobiMeasure <: AbstractCanonicalMeasure
    ...
    function JacobiMeasure(shape_a::Real, shape_b::Real)
        ...
        new(build_w_jacobi(shape_a, shape_b), (-1, 1), isapprox(shape_a, shape_b), shape_a,
            shape_b)
    end
end
